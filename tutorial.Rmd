...
|-----|------|------|-------------|
| 1 | `IncidntNum` | categorical unordered | Incident Number(ID) |
...
```
Since the outcome is binary, We used a Logistic regression this time to fit the model. 
...
```
Then, we can build a regression  model for number of incident by the hour. 
...
>>>>>>> 94455303985c0909dd1be22775863f00a92c6dd7
```